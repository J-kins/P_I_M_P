...
<?php
/**
 * Footer components for PHP UI Template System
 */
 ...
 */
function standardFooter(array $params = []): string {
    $copyright = $params['copyright'] ?? '© ' . date('Y') . ' PHP UI Template';
            ...
            <nav class="footer-nav" aria-label="Footer navigation">
                <ul class="footer-nav-list">
                    ...
                    <li class="footer-nav-item">
                        <a href="<?= url($item['url']) ?>" class="footer-link">
 ...
 * @return string HTML output
 */
function multiColumnFooter(array $params = []): string {
    $copyright = $params['copyright'] ?? '© ' . date('Y') . ' PHP UI Template';
        ...
        <div class="container">
            <div class="footer-main">
                    ...
                    <div class="footer-column">
                        ...
                        <ul class="footer-links">
                            ...
                            <li class="footer-link-item">
                                <a href="<?= url($link['url']) ?>" class="footer-link">
                ...
                <div class="footer-newsletter">
                    ...
                    <form action="<?= url($newsletterForm['action'] ?? '#') ?>" method="post" class="newsletter-form">
            ...
            <div class="footer-bottom">
                ...
                <?php if (!empty($params['bottomLinks'])): ?>
                <div class="footer-bottom-links">
                    <ul class="bottom-link-list">
                        <?php foreach ($params['bottomLinks'] as $link): ?>
                        <li class="bottom-link-item">
                            <a href="<?= url($link['url']) ?>" class="bottom-link">
                                <?= htmlspecialchars($link['label']) ?>
                            </a>
                        </li>
                        <?php endforeach; ?>
 ...
 * @return string HTML output
 */
function modernFooter(array $params = []): string {
    $copyright = $params['copyright'] ?? '© ' . date('Y') . ' PHP UI Template';
    $links = $params['links'] ?? [];
    ...
    <footer class="footer footer-modern footer-theme-<?= htmlspecialchars($theme) ?>">
        <div class="container">
                ...
                <div class="footer-downloads">
                    ...
                    <div class="download-buttons">
                        ...
                        <a href="<?= htmlspecialchars($appDownloads['ios']) ?>" class="download-button download-ios">
                            <img src="<?= asset_url('img/app-store-badge.svg') ?>" alt="Download on App Store">
                        </a>
                        <?php endif; ?>
                        
                        <?php if (!empty($appDownloads['android'])): ?>
                        <a href="<?= htmlspecialchars($appDownloads['android']) ?>" class="download-button download-android">
                            <img src="<?= asset_url('img/google-play-badge.svg') ?>" alt="Get it on Google Play">
                        </a>
                        <?php endif; ?>
                    </div>
                </div>
            ...
            <div class="footer-bottom">
                ...
                <?php if (!empty($params['socialLinks'])): ?>
                <div class="footer-social">
                    <?php foreach ($params['socialLinks'] as $social): ?>
                    <a href="<?= htmlspecialchars($social['url']) ?>" 
                       class="social-link social-<?= htmlspecialchars($social['platform']) ?>"
                       aria-label="<?= htmlspecialchars($social['platform']) ?>">
                        <?= $social['icon'] ?>
 ...
 * @return string HTML output
 */
function documentClose(array $params = []): string {
    ob_start(); ?>
    <?php if (!empty($params['scripts'])): ?>
 ...
 * @return string HTML output
 */
function minimalFooter(array $params = []): string {
    $copyright = $params['copyright'] ?? '© ' . date('Y') . ' PHP UI Template';
    $links = $params['links'] ?? [];
    $theme = $params['theme'] ?? 'light';
 ...
 * 
 * @param array $params Footer settings
 * @return string HTML output
 */
function newsletterFooter(array $params = []): string {
        ...
        <div class="container">
            <div class="newsletter-container">
                ...
                <div class="newsletter-form-container">
                    <form action="<?= url($action) ?>" method="post" class="newsletter-form">
                        <div class="form-group">
